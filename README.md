...
* ***PostgreSQL***: 
    ...
    * **WHY?** The most used Relational Mapping Database (RMDB) because of its capabilities and efficiency. *NoSQL* was another option, but I believe that in my position (I'm data not backend) Postgres would be more useful to start with, at least.
* ***FastAPI***:
